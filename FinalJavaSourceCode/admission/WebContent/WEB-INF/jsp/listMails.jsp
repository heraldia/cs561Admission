...
<script type="text/javascript" language="javascript" src="js/jquery.dataTables.js"></script>
    ...
    <div class="grids clearfix">
		...
		<h1> </h1>
			<br>
			<h1>
				<bean:message key="page.mails" />
			</h1>
			 <div id="logout">
            <html:link action="/logout">Logout</html:link><br>
            <html:link action="/listMails.do?method=ms">MS</html:link><br>
            <html:link action="/listMails.do?method=phd">PHD</html:link><br>
            <html:link action="/listMails.do?method=all">Full List</html:link><br>
            </div>
			<hr>
